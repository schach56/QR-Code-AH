...
object chartJsStrings {
  ...
  @js.native
  sealed trait afterScaleUpdate extends StObject
  inline def afterScaleUpdate: afterScaleUpdate = "afterScaleUpdate".asInstanceOf[afterScaleUpdate]
  ...
  sealed trait `x-axis`
    extends StObject
       with InteractionMode
  inline def `x-axis`: `x-axis` = "x-axis".asInstanceOf[`x-axis`]

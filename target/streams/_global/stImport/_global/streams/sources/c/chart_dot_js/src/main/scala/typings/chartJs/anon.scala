...
object anon {
  ...
  object ChartOptionsChartFontOpti {
    ...
    inline def apply(): ChartOptionsChartFontOpti = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ChartOptionsChartFontOpti]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: ChartOptionsChartFontOpti] (val x: Self) extends AnyVal {
      ...
      inline def setDefaultColorVarargs(value: String*): Self = StObject.set(x, "defaultColor", js.Array(value*))
      ...
      inline def setOnClick(
        value: (/* event */ js.UndefOr[MouseEvent], /* activeElements */ js.UndefOr[js.Array[js.Object]]) => Any
  ...
  object keyinPositionTypenumber {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: keyinPositionTypenumber] (val x: Self) extends AnyVal {

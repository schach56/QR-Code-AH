...
trait PointLabelOptions extends StObject {
  ...
  var callback: js.UndefOr[js.Function1[/* arg */ Any, Any]] = js.undefined
...
object PointLabelOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PointLabelOptions] (val x: Self) extends AnyVal {
    
    inline def setCallback(value: /* arg */ Any => Any): Self = StObject.set(x, "callback", js.Any.fromFunction1(value))

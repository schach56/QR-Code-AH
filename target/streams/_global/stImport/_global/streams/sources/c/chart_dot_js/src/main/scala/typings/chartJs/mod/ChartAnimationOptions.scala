...
trait ChartAnimationOptions extends StObject {
  ...
  var onComplete: js.UndefOr[js.Function1[/* chart */ Any, Unit]] = js.undefined
  
  var onProgress: js.UndefOr[js.Function1[/* chart */ Any, Unit]] = js.undefined
}
object ChartAnimationOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ChartAnimationOptions] (val x: Self) extends AnyVal {
    ...
    inline def setOnComplete(value: /* chart */ Any => Unit): Self = StObject.set(x, "onComplete", js.Any.fromFunction1(value))
    
    inline def setOnCompleteUndefined: Self = StObject.set(x, "onComplete", js.undefined)
    
    inline def setOnProgress(value: /* chart */ Any => Unit): Self = StObject.set(x, "onProgress", js.Any.fromFunction1(value))

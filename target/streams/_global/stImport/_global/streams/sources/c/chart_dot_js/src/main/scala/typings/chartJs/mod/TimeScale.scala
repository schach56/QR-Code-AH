...
trait TimeScale
  ...
  var parser: js.UndefOr[String | (js.Function1[/* arg */ Any, Any])] = js.undefined
...
object TimeScale {
  ...
  implicit open class MutableBuilder[Self <: TimeScale] (val x: Self) extends AnyVal {
    ...
    inline def setParser(value: String | (js.Function1[/* arg */ Any, Any])): Self = StObject.set(x, "parser", value.asInstanceOf[js.Any])
    
    inline def setParserFunction1(value: /* arg */ Any => Any): Self = StObject.set(x, "parser", js.Any.fromFunction1(value))

...
object NestedTickOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: NestedTickOptions] (val x: Self) extends AnyVal {
    ...
    inline def setBackdropColorVarargs(value: String*): Self = StObject.set(x, "backdropColor", js.Array(value*))

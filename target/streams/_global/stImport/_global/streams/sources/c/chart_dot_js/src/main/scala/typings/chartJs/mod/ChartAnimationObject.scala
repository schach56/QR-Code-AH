...
trait ChartAnimationObject extends StObject {
  ...
  var onAnimationComplete: js.UndefOr[js.Function1[/* arg */ Any, Unit]] = js.undefined
  
  var onAnimationProgress: js.UndefOr[js.Function1[/* arg */ Any, Unit]] = js.undefined
  
  var render: js.UndefOr[js.Function1[/* arg */ Any, Unit]] = js.undefined
}
object ChartAnimationObject {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ChartAnimationObject] (val x: Self) extends AnyVal {
    ...
    inline def setOnAnimationComplete(value: /* arg */ Any => Unit): Self = StObject.set(x, "onAnimationComplete", js.Any.fromFunction1(value))
    
    inline def setOnAnimationCompleteUndefined: Self = StObject.set(x, "onAnimationComplete", js.undefined)
    
    inline def setOnAnimationProgress(value: /* arg */ Any => Unit): Self = StObject.set(x, "onAnimationProgress", js.Any.fromFunction1(value))
    
    inline def setOnAnimationProgressUndefined: Self = StObject.set(x, "onAnimationProgress", js.undefined)
    
    inline def setRender(value: /* arg */ Any => Unit): Self = StObject.set(x, "render", js.Any.fromFunction1(value))

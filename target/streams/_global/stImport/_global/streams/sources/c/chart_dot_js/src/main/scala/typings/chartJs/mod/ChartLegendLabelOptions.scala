...
trait ChartLegendLabelOptions extends StObject {
  ...
  var filter: js.UndefOr[js.Function2[/* legendItem */ ChartLegendLabelItem, /* data */ ChartData, Any]] = js.undefined
...
object ChartLegendLabelOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ChartLegendLabelOptions] (val x: Self) extends AnyVal {
    ...
    inline def setFilter(value: (/* legendItem */ ChartLegendLabelItem, /* data */ ChartData) => Any): Self = StObject.set(x, "filter", js.Any.fromFunction2(value))
    ...
    inline def setFontColorVarargs(value: String*): Self = StObject.set(x, "fontColor", js.Array(value*))

...
object GridLineOptions {
  ...
  implicit open class MutableBuilder[Self <: GridLineOptions] (val x: Self) extends AnyVal {
    ...
    inline def setZeroLineBorderDashVarargs(value: Double*): Self = StObject.set(x, "zeroLineBorderDash", js.Array(value*))
    ...
    inline def setZeroLineColorVarargs(value: String*): Self = StObject.set(x, "zeroLineColor", js.Array(value*))

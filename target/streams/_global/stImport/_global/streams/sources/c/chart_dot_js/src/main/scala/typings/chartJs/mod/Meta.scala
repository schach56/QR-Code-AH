...
trait Meta extends StObject {
  ...
  @JSName("$filler")
  var $filler: js.UndefOr[StringDictionary[Any]] = js.undefined
  
  var controller: StringDictionary[Any]
...
object Meta {
  ...
  inline def apply(controller: StringDictionary[Any], data: js.Array[MetaData], `type`: ChartType): Meta = {
  ...
  implicit open class MutableBuilder[Self <: Meta] (val x: Self) extends AnyVal {
    ...
    inline def set$filler(value: StringDictionary[Any]): Self = StObject.set(x, "$filler", value.asInstanceOf[js.Any])
    
    inline def set$fillerUndefined: Self = StObject.set(x, "$filler", js.undefined)
    
    inline def setController(value: StringDictionary[Any]): Self = StObject.set(x, "controller", value.asInstanceOf[js.Any])
    
    inline def setData(value: js.Array[MetaData]): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
    
    inline def setDataVarargs(value: MetaData*): Self = StObject.set(x, "data", js.Array(value*))

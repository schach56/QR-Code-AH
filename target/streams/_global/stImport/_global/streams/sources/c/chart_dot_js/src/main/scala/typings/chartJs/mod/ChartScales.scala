...
object ChartScales {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ChartScales] (val x: Self) extends AnyVal {
    ...
    inline def setXAxesVarargs(value: ChartXAxe*): Self = StObject.set(x, "xAxes", js.Array(value*))
    ...
    inline def setYAxesVarargs(value: ChartYAxe*): Self = StObject.set(x, "yAxes", js.Array(value*))
  }
}

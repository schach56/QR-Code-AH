...
object ChartTooltipOptions {
  ...
  implicit open class MutableBuilder[Self <: ChartTooltipOptions] (val x: Self) extends AnyVal {
    ...
    inline def setBodyFontColorVarargs(value: String*): Self = StObject.set(x, "bodyFontColor", js.Array(value*))
    ...
    inline def setFooterFontColorVarargs(value: String*): Self = StObject.set(x, "footerFontColor", js.Array(value*))
    ...
    inline def setTitleFontColorVarargs(value: String*): Self = StObject.set(x, "titleFontColor", js.Array(value*))
